...
SECRET_KEY = settings_env.DJANGO_SECRET
DEBUG = settings_env.APP_ENV == "local"
ALLOWED_HOSTS = ["*"]
...
MIDDLEWARE = [
    ...
    "shared.errors.handlers.DjangoGlobalExceptionMiddleware",
    "shared.logging.middleware.DjangoRequestLoggingMiddleware",
]
